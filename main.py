...
async def ensure_structure(guild):
    print("\n[3/5] Verificando categorías y canales...")
...
async def on_ready():
    ...
    try:
        ...
        print("\n[5/5] TERMINADO")
        print("✅ Santacho FC quedó actualizado al nuevo estilo.")
        print("✅ NO cierres esta ventana si quieres que botones/tickets sigan funcionando.")
        print("✅ Comandos: /disponibilidad /convocatoria /resultado /paneles")
